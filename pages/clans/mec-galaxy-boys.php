...
<body class="body-light">
    ...
    $team = isset($_GET['team']) ? htmlspecialchars($_GET['team']) : 'MEC Galaxy Boys'; // Default team if not provided
    ...
    <?php foreach ($players as $player): ?>  <!-- Use all players for card display -->
        ...
        <div class="player-card">
            <img src="/assets/images/players/MEC_galaxy_boys/<?php print $player['img']; ?>.jpg" alt="<?php print $player['player_name']; ?>" />
